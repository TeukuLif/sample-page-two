...
const SpecialOffer = () => {
    return (
        <section className="flex justifiy-wrap items-center max-lg:flex-col-reverse gap-10 max-container">
            ...
            <div className="flex flex-1 flex-col">
                ...
                <p className='mt-6 lg:max-w-lg info-text'>Navigate a realm of possibilities designed to fulfill your unique desires suprassing
